...
function preserveSubmittedAt(reports, existing) {
  if (
    !existing ||
...
async function main() {
  ...
  /*
    Preserve the original submittedAt timestamp
    for reports that have not actually changed.
    This prevents GitHub Actions from creating
    unnecessary commits every six hours.
  */
